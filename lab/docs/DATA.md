...
> 更新：2026-08-13 ｜ 数据文件：`ml/data/dataset.pt` ｜ 构建脚本：`ml/build_dataset.py`
...
| 每流特征 | 55 维 meta（16 行为 + 39 CIC）+ 事件序列（≤96 事件）+ 标签/工具/来源 |

恶意构成：

| 组成 | 标签 | 流数 |
|---|---:|---:|
| 59 个集成工具（webshell/c2/tunnel/rat/apt） | 59 | 460 |
...
| 来源 | 流数 |
|---|---:|
| 本机真实捕获 `data/captures/real_traffic{1-4}.pcap` | 1,471 |
